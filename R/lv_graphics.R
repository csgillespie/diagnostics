...
sim_mc_30 = readRDS(file="data/lv_mc_30.RData")
sim_mc_100 = readRDS(file="data/lv_mc_100.RData")
sim_lna_30 = readRDS(file="data/lv_lna_30.RData")
sim_lna_100 = readRDS(file="data/lv_lna_100.RData")
probs_30 = readRDS(file="data/lv_extinction_t30.RData")
probs_100 = readRDS(file="data/lv_extinction_t100.RData")
...
###########################################################
mc = sim_mc_30; lna = sim_lna_30;probs = probs_30
#mc = sim_mc_100; lna = sim_lna_100; probs = probs_100
...
dd$prob = probs[,1]/1000
#dd = dd[-c(44, 79),]
table(dd$Extreme)
g1 = ggplot(dd, aes(x1, x2)) + 
  geom_point(aes(colour=Extreme, size=prob)) + 
...
#ggThemeAssist::ggThemeAssistGadget(g1)

g1a = g1 + theme(legend.position = "top", legend.direction = "horizontal") + 
